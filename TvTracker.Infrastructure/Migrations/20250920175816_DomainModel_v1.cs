...
{
    /// <inheritdoc />
    public partial class DomainModel_v1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CastMembers", x => new { x.TvShowId, x.ActorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirTime = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
